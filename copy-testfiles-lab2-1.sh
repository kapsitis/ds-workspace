...
cp run-plain-lab2-1.sh ${targetDir}/
...
cp lab2-1/Makefile ${targetDir}/lab2-1/
...
cp lab2-1/cmake/Modules/ParseAndAddCatchTests.cmake ${targetDir}/lab2-1/cmake/Modules/
